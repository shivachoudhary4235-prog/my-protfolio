...
export default async function ProjectsPage() {
  ...
  return (
    <main className="relative flex flex-col items-center overflow-x-hidden min-h-screen">
      ...
      <section className="relative w-full py-40 px-4 md:px-8 max-w-7xl mx-auto flex-1">
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight text-white mb-6">
              Our complete portfolio of <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-light">digital experiences.</span>
            </h1>
            <p className="text-lg text-text-muted font-light">
              Explore the websites and applications we've built for clients worldwide.
            </p>
          </div>
        </div>
